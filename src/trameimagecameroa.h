...
struct EnteteTrameDonneesCamerOA
{
	...
	uint32_t tx;									// La dimension en abscisse de l'image  (on va envoyer de l'unsigned short 16 bits)
	uint32_t ty;									// La dimension en ordonnee de l'image
	QDateTime debut;									// Heure du debut de pose
	QDateTime fin;										// Heure de fin de pose
	int32_t duree;											// Duree de la pose en 1/10000 de seconde
};
